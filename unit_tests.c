...
#define ASSERT_POSEIDON_EQ(type, inputs, output) { \
  PoseidonCtx ctx; \
  poseidon_init(&ctx, type, NULLNET_ID); \
...
int main(int argc, char* argv[]) {
  ...
  ASSERT_POSEIDON_EQ(
    POSEIDON_3W,
    ARRAY_SAFE({
      {13568896335663078044ULL, 12780551435489493364ULL, 7939944734757335782ULL, 2716817606766379733},
      {8340509593943796912ULL, 14326728421072412984ULL, 1939214290157533341ULL, 248823904156563876},
      {18138459445226614284ULL, 7569000930215382240ULL, 12226032416704596818ULL, 754852930030810284},
      {11813108562003481058ULL, 3775716673546104688ULL, 7004407702567408918ULL, 2198318152235466722},
      {9752122577441799495ULL, 2743141496725547769ULL, 8526535807986851558ULL, 1154473298561249145},
      {12335717698867852470ULL, 17616685850532508842ULL, 8342889821739786893ULL, 2726231867163795098}
    }),
    ARRAY_SAFE(
